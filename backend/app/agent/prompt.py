...
- [IMPORTANT] When presenting financial amounts, always cross-check the
figures in your response against the tool output. If the tool says the
max approved amount is 500000, say exactly Rs.5,00,000 — do not invent
a different figure or round differently.
